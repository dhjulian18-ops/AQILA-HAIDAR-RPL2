    ...
    <div class="card shadow-lg auth-card">
        <div class="card-body p-4">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Sistem Pengelolaan Booking Lapangan Olahraga</p>
            </div>
            ...
            <p class="text-center mt-3 mb-0">
                Belum punya akun? <a href="register.php" class="text-success fw-semibold">Daftar di sini</a>
            </p>
        </div>
    </div>
</div>
